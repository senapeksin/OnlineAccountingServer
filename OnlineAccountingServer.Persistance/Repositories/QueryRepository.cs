...
namespace OnlineAccountingServer.Persistance.Repositories
{
    ...
    {
        public static readonly Func<CompanyDbContext, string, bool, Task<T>>
             GetByIdCompiled =
        ...
        public static readonly Func<CompanyDbContext, bool, Task<T>>
            GetFirstCompiled =
        ...
        public static readonly Func<CompanyDbContext, Expression<Func<T, bool>>, bool, Task<T>>
